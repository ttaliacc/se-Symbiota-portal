...
if(!file_exists('../../content/collections/occureditor/occurEditorDefaultConf.php')){
	echo 'ERROR: Portal is not configured properly. Go to directory '.$SERVER_ROOT.'/content/collections/occureditor/ and rename all file to remove "_template" for the file name. ';
